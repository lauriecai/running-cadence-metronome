...
#ifndef RUNNING_CADENCE_METRONOME_WATCH_SWIFT_H
#define RUNNING_CADENCE_METRONOME_WATCH_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Running_Cadence_Metronome_Watch",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC31Running_Cadence_Metronome_Watch26WatchMetronomeAudioService")
@interface WatchMetronomeAudioService : NSObject
