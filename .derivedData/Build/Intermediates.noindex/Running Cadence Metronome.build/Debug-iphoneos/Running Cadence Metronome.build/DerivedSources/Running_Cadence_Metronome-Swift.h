...
#ifndef RUNNING_CADENCE_METRONOME_SWIFT_H
#define RUNNING_CADENCE_METRONOME_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Running_Cadence_Metronome",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC25Running_Cadence_Metronome21MetronomeAudioService")
@interface MetronomeAudioService : NSObject
